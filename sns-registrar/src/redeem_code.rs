...
//!
//! All the above methods require manager privileges in `snsOrigin`.
...
pub mod pallet {
    ...
    pub enum Error<T> {
        ...
        /// Are you sure you are getting this error on the official SNS web page?
        ///
    ...
    impl<T: Config> Pallet<T> {
        ...
        /// This is an interface to the SNS front-end.
        ///
        /// Although you can also call it, but not through
        /// the `redemption code` to call the interface.
        ///
        /// The SNS front-end gets the `name`,`duration`,`nouce` and `code` from
        ...
        /// This is an interface to the SNS front-end.
        ///
        /// The SNS front-end gets `duration`, `nouce` and `code`
