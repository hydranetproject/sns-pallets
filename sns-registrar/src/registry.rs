...
//! and provides `SnsOfficial` storage.
//!
//!
//! ## Introduction
//!
//! Most of the methods of this module are abstracted to higher-level
//! domain name distribution calls (sns-registrar, sns-auction......).
...
pub mod pallet {
    ...
    pub enum Error<T> {
        ...
        ApprovalFailure,
        /// Sns official account is not initialized, please feedback to the official.
    ...
    // Methods that do not need to consider permission issues can be used directly
    impl<T: Config> Pallet<T> {
        #[inline(always)]
...
impl<T: pallet::Config> crate::traits::Registry for pallet::Pallet<T> {
    ...
    /// Facilitate follow-up judgment authority
