...
//! authentication for `sns-pallets`. Considering that `sns-pallets`
//! does not routinely obtain administrator privileges on the chain,
//! this interface is provided to operate and maintain `sns-pallets`.
//!
//! ## Introduction
//!
//! This module provides storage to mark which account is the manager
//!  and to enable or disable `sns` domain registration.
//!
//! ### Module functions
//!
