...
// sel : [63, 206, 125, 19, 100, 168, 147, 226, 19, 188, 66, 18, 121, 43, 81, 127, 252, 136, 245, 177, 59, 134, 200, 239, 156, 141, 57, 12, 58, 19, 112, 206]
pub const SEL_BASENODE: H256 = sp_core::H256([
...
frame_support::construct_runtime!(
        ...
        UncheckedExtrinsic = UncheckedExtrinsic,
    {
        ...
        Resolvers: sns_resolvers::resolvers,
        Nft: crate::nft,
...
impl sns_resolvers::resolvers::Config for Test {
    type Event = Event;
...
impl sns_resolvers::resolvers::RegistryChecker for TestChecker {
    type Hash = Hash;
...
parameter_types! {
    ...
    pub const BaseNode: Hash = SEL_BASENODE;
}
